...
2. **녹화 영상 업로드**
    - 녹화된 `.h264` 영상을 `.mp4`로 변환 후 Firebase Storage에 업로드.
...
사용자가 **마이크 버튼**을 길게 누르면 음성을 녹음하여 라즈베리파이에 전송
